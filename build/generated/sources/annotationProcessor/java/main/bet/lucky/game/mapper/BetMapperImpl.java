...
@Generated(
    ...
    date = "2021-11-13T09:59:52+0700",
    comments = "version: 1.3.0.Final, compiler: javac, environment: Java 11.0.12 (JetBrains s.r.o.)"
)
@Component
public class BetMapperImpl implements BetMapper {
    ...
    protected BetTopResponse betTopToBetTopResponse(BetTop betTop) {
        ...
        betTopResponse.setStake( betTop.getStake() );
